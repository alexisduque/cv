...
{{\thinfont #1}{\bodyfont  #2}\\[6pt]{\bodyfont\large PhD Student - Research Engineer}}
{}{}
...
\entry
  ...
  Accurate indoor positioning  using a smartphone phone\\
  Working toward  Device-to-Device communication using LED lights }
%------------------------------------------------
\entry
  {2014-- Now}
  {Rtone}
  ...
  \begin{itemize}
    \item Body-Area-Network development in a sport context
...
{CITI Lab}
{\bodyfontit{INRIA Urbanet Team, funded by Rtone}}
%------------------------------------------------
\entry
{2009--2015}
...
\textbf{professional :} technological watch,  free and open-source software activist, contributor at OpenMRS, Google Summer of Code 2014 student\\
